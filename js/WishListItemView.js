(() => {
  ...
  var C = (t3, i3) => {
    ...
    for (let i4 = 0; i4 < o6; i4++) {
      ...
      for (; p2 < s5.length && (d2.lastIndex = p2, u3 = d2.exec(s5), u3 !== null); )
        p2 = d2.lastIndex, d2 === c ? u3[1] === "!--" ? d2 = v : u3[1] !== void 0 ? d2 = a2 : u3[2] !== void 0 ? (g.test(u3[2]) && (h3 = RegExp("</" + u3[2], "g")), d2 = f) : u3[3] !== void 0 && (d2 = f) : d2 === f ? u3[0] === ">" ? (d2 = h3 != null ? h3 : c, $2 = -1) : u3[1] === void 0 ? $2 = -2 : ($2 = d2.lastIndex - u3[2].length, o7 = u3[1], d2 = u3[3] === void 0 ? f : u3[3] === '"' ? m : _14) : d2 === m || d2 === _14 ? d2 = f : d2 === v || d2 === a2 ? d2 = c : (d2 = f, h3 = void 0);
  ...
  function flattenTypeErrors(errors2) {
    return errors2.reduce(function(a3, i3) {
      return a3.concat(i3);
    }, []);
  }
  ...
  function areSame(oldNode, newValue) {
    ...
    return oldNode.identifier !== null && oldNode.identifierAttribute && isPlainObject2(newValue) && oldNodeType.is(newValue) && oldNodeType.isMatchingSnapshotId(oldNode, newValue);
  }
  ...
  var WishListItem = types.model({
    ...
    changePrice(newPrice) {
      self2.price = newPrice;
    },
    changeImage(newImage) {
      self2.image = newImage;
    }
  }));
  var WishList = types.model({
    ...
    get totalPrice() {
      return self2.items.reduce((sum, entry) => sum + entry.price, 0);
    }
  }));

  // src/WishListItemView.ts
  var itemsRow = ({ name, price, image }) => p`
<tr>
<td>${name}</td>
<td>${price}</td>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=WishListItemView.js.map
